...
public class Pin extends JFrame implements ActionListener {
    ...
    Pin(String pin) {
        ...
        l1.setBounds(230, 290, 800, 35);
        l4.add(l1);

        l2.setBounds(140, 330, 150, 35);
        l4.add(l2);

        l3.setBounds(140, 370, 150, 35);
        l4.add(l3);

        t1.setBounds(300, 330, 150, 25);
        l4.add(t1);

        t2.setBounds(300, 370, 150, 25);
        l4.add(t2);

        b1.setBounds(305, 483, 150, 35);
        l4.add(b1);

        b2.setBounds(305, 518, 150, 35);
        l4.add(b2);
